                        ...
                        child: new ClipRRect(
                          ...
                          child: new Container(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: Config.userImageUrl + "" + user.userid,
                              fit: BoxFit.cover,
                            ),
                          )
                        ),
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[
                            Text(user.fullname,style: textBoldWhite,),
                            Container(
                              ...
                              RatingBar(
                                ...
                                ignoreGestures: true,
                                initialRating:  double.parse(user.rating),
                                itemSize: 15.0,
                                itemCount: 5,
                      ...
                      Container(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(user.hours,style: heading18,),
                      ...
                      Container(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(user.distance + " Km",style: heading18,),
                      ...
                      Container(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(user.tickets,style: heading18,),
                            Text("Total Job",style: TextStyle(
                              fontSize: 11,
                              color: greyColor,
                            ),),
                          ],
